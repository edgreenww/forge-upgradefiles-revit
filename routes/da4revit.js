...
const createStorage = async (req, unzippedFilePath) => {
    ...
    const createStoragePromise = betterCreateStorage(req, fileName )

    createStoragePromise.then( 
        (result) => {
            console.log('StoragePromise resolved')
            return result

        },
        (result) => {
            console.log('StoragePromise rejected')
            return result
